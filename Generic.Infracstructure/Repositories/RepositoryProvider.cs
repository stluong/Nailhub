...
namespace Generic.Infrastructure.Repositories
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public IMyContextAsync DataContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<IMyContextAsync, IUnitOfWorkAsync, dynamic> factory = null) where T : class
        {
        ...
        private Func<dynamic> GetFactory(Type type)
        {
            ...
            if (_repositoryFactories.CustomRepositoryFactory.TryGetValue(type, out repository))
            {
                return repository;
            }
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<IMyContextAsync, IUnitOfWorkAsync, dynamic> factory, IMyContextAsync dbContext, IUnitOfWorkAsync unitOfWorkAsync)
        {
